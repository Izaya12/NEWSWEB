...
<div class="card mb-3" style="max-width: 1400px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="{{ $dat['image_url']}}" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">Publish at:{{ $dat['publish_date']}}</small></p>
        <a style="background-color:#DE3163" href="{{ $dat['link']}}" class ="btn bg-dark: text-white">READ MORE</a>
      </div>
    </div>
  </div>
</div>
